...
(function ($) {
	...
	// create control
	function createControl(type, ctrlId, ctrlName, classNames, displayCss)
	{
	    ctrl = document.createElement(type);
		ctrl.id = ctrlId;
		if(isEmpty(ctrlName))
		{
		   ctrlName= ctrlId;		   		  
		...
		{
		    ctrl.className +=(' '+classNames);
		}
		
		if(!isEmpty(displayCss)
		{
		   $(ctrl).css(displayCss);
		}
        return ctrl;		
	...
	function createCheckBox(tbCell, ctrlId, ctrlName, classNames, displayCss)
	{
	    ctrl = createControl('input', ctrlId, ctrlName, classNames, displayCss);	    
        ctrl.type = 'checkbox';       
        ctrl.value = 1;
        tbCell.appendChild(ctrl);
        tbCell.style.textAlign = 'center';  
	}
	function createSelectMenu(tbCell, ctrlId, ctrlName, classNames, css, ctrlOptions)
	{
